...
class TestTheInternetHerokuSeleniumTestApp():
  ...
  def test_theInternetHerokuSeleniumTestApp(self):
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, ".example > button")
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".added-manually:nth-child(4)").click()
    # 33 | click | css=.added-manually:nth-child(4) |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".added-manually:nth-child(4)").click()
    # 34 | doubleClick | css=.added-manually:nth-child(3) |  | 
    element = self.driver.find_element(By.CSS_SELECTOR, ".added-manually:nth-child(3)")
    actions = ActionChains(driver)
    actions.double_click(element).perform()
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".added-manually:nth-child(3)").click()
    # 49 | click | css=.added-manually:nth-child(2) |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".added-manually:nth-child(2)").click()
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, "img:nth-child(3)")
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    # 58 | mouseOver | css=img:nth-child(4) |  | 
    element = self.driver.find_element(By.CSS_SELECTOR, "img:nth-child(4)")
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    ...
    self.driver.find_element(By.ID, "a84e9fa0-932d-0137-8c8c-7a12225e6570").click()
    # 61 | click | id=a996cd70-932d-0137-8ca1-7a12225e6570 |  | 
    self.driver.find_element(By.ID, "a996cd70-932d-0137-8ca1-7a12225e6570").click()
    # 62 | click | id=aabce840-932d-0137-8cca-7a12225e6570 |  | 
    self.driver.find_element(By.ID, "aabce840-932d-0137-8cca-7a12225e6570").click()
    # 63 | click | css=tr:nth-child(3) a:nth-child(1) |  | 
    self.driver.find_element(By.CSS_SELECTOR, "tr:nth-child(3) a:nth-child(1)").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "tr:nth-child(3) a:nth-child(2)").click()
    # 67 | click | id=abaf7270-932d-0137-8cdc-7a12225e6570 |  | 
    self.driver.find_element(By.ID, "abaf7270-932d-0137-8cdc-7a12225e6570").click()
    # 68 | click | css=tr:nth-child(4) a:nth-child(2) |  | 
    self.driver.find_element(By.CSS_SELECTOR, "tr:nth-child(4) a:nth-child(2)").click()
    ...
    self.driver.find_element(By.ID, "hot-spot").click()
    # 77 | assertAlert | You selected a context menu |  | 
    assert self.driver.switch_to.alert.text == "You selected a context menu"
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, "body").text == "Not Found"
    ...
    self.driver.find_element(By.LINK_TEXT, "Portfolio").click()
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".row:nth-child(1) > .large-10").text == "Accusantium eius ut architecto neque vel voluptatem vel nam eos minus ullam dolores voluptates enim sed voluptatem rerum qui sapiente nesciunt aspernatur et accusamus laboriosam culpa tenetur hic aut placeat error autem qui sunt."
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#checkbox > input").click()
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, "button:nth-child(1)")
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, "button:nth-child(2)")
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    # 116 | click | css=#input-example > input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "#input-example > input").click()
    # 117 | click | css=#input-example > input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "#input-example > input").click()
    # 118 | type | css=#input-example > input | Crack your Selenium Interview | 
    self.driver.find_element(By.CSS_SELECTOR, "#input-example > input").send_keys("Crack your Selenium Interview")
    # 119 | click | id=input-example |  | 
    self.driver.find_element(By.ID, "input-example").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "h4:nth-child(1)").click()
    # 128 | click | css=h4:nth-child(1) |  | 
    self.driver.find_element(By.CSS_SELECTOR, "h4:nth-child(1)").click()
    # 129 | click | linkText=Example 2: Element rendered after the fact |  | 
    self.driver.find_element(By.LINK_TEXT, "Example 2: Element rendered after the fact").click()
    # 130 | click | css=button |  | 
    self.driver.find_element(By.CSS_SELECTOR, "button").click()
    # 131 | assertText | css=h4:nth-child(1) | Hello World! | 
    assert self.driver.find_element(By.CSS_SELECTOR, "h4:nth-child(1)").text == "Hello World!"
    # 132 | verifyText | css=h4:nth-child(1) | Hello World! | 
    assert self.driver.find_element(By.CSS_SELECTOR, "h4:nth-child(1)").text == "Hello World!"
    # 133 | click | linkText=Entry Ad |  | 
    self.driver.find_element(By.LINK_TEXT, "Entry Ad").click()
    # 134 | verifyText | css=.modal-title | THIS IS A MODAL WINDOW | 
    assert self.driver.find_element(By.CSS_SELECTOR, ".modal-title").text == "THIS IS A MODAL WINDOW"
    # 135 | click | css=.modal-footer > p |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".modal-footer > p").click()
    # 136 | click | id=restart-ad |  | 
    self.driver.find_element(By.ID, "restart-ad").click()
    # 137 | click | css=.modal-footer > p |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".modal-footer > p").click()
    # 138 | click | linkText=Exit Intent |  | 
    self.driver.find_element(By.LINK_TEXT, "Exit Intent").click()
    # 139 | verifyText | css=p:nth-child(2) | Mouse out of the viewport pane and see a modal window appear. | 
    assert self.driver.find_element(By.CSS_SELECTOR, "p:nth-child(2)").text == "Mouse out of the viewport pane and see a modal window appear."
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".modal").text == "THIS IS A MODAL WINDOW\nIt\\'s commonly used to encourage a user to take an action (e.g., give their e-mail address to sign up for something).\nClose"
    ...
    self.driver.find_element(By.LINK_TEXT, "simple.txt").click()
    # 145 | click | linkText=simple.txt |  | 
    self.driver.find_element(By.LINK_TEXT, "simple.txt").click()
    # 146 | storeText | linkText=some-file.txt | test | 
    self.vars["test"] = self.driver.find_element(By.LINK_TEXT, "some-file.txt").text
    ...
    self.driver.find_element(By.ID, "file-upload").send_keys("C:\fakepath\simple.txt")
    # 150 | click | id=file-submit |  | 
    self.driver.find_element(By.ID, "file-submit").click()
    # 151 | assertText | id=uploaded-files | simple.txt | 
    assert self.driver.find_element(By.ID, "uploaded-files").text == "simple.txt"
    # 152 | click | linkText=Floating Menu |  | 
    self.driver.find_element(By.LINK_TEXT, "Floating Menu").click()
    ...
    self.driver.find_element(By.ID, "email").send_keys("a@b.c")
    ...
    self.driver.find_element(By.ID, "password").send_keys("SuperSecretPassword!2")
    # 173 | click | css=.fa |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".fa").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "body").click()
    # 199 | verifyTitle |  |  | 
    assert self.driver.title == "undefined"
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#mceu_15-open > span").click()
    # 204 | click | id=mceu_32 |  | 
    self.driver.find_element(By.ID, "mceu_32").click()
    # 205 | mouseOver | id=mceu_15-open |  | 
    element = self.driver.find_element(By.ID, "mceu_15-open")
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    # 206 | mouseOver | css=#mceu_1 > button |  | 
    element = self.driver.find_element(By.CSS_SELECTOR, "#mceu_1 > button")
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#mceu_16-open > span").click()
    # 209 | selectFrame | index=0 |  | 
    self.driver.switch_to.frame(0)
    # 210 | editContent | id=tinymce | <p><br data-mce-bogus="1"></p> | 
    element = self.driver.find_element(By.ID, "tinymce")
    self.driver.execute_script("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p><br data-mce-bogus=\"1\"></p>'}", element)
    # 211 | click | css=html |  | 
    self.driver.find_element(By.CSS_SELECTOR, "html").click()
    # 212 | selectFrame | relative=parent |  | 
    self.driver.switch_to.default_content()
    # 213 | click | id=mceu_15-open |  | 
    self.driver.find_element(By.ID, "mceu_15-open").click()
    # 214 | selectFrame | index=0 |  | 
    self.driver.switch_to.frame(0)
    # 215 | editContent | id=tinymce | <p>Cracking Your Selenium Interview</p> | 
    element = self.driver.find_element(By.ID, "tinymce")
    self.driver.execute_script("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p>Cracking Your Selenium Interview</p>'}", element)
    # 216 | selectFrame | relative=parent |  | 
    self.driver.switch_to.default_content()
    # 217 | mouseOver | id=mceu_16-open |  | 
    element = self.driver.find_element(By.ID, "mceu_16-open")
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#mceu_18-open > span").click()
    # 222 | click | id=mceu_48-text |  | 
    self.driver.find_element(By.ID, "mceu_48-text").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "button > .mce-i-bold").click()
    # 227 | mouseOver | css=button > .mce-i-bold |  | 
    element = self.driver.find_element(By.CSS_SELECTOR, "button > .mce-i-bold")
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "button > .mce-i-italic").click()
    # 230 | click | css=#mceu_2-open > span |  | 
    self.driver.find_element(By.CSS_SELECTOR, "#mceu_2-open > span").click()
    # 231 | mouseOver | css=#mceu_2-open > span |  | 
    element = self.driver.find_element(By.CSS_SELECTOR, "#mceu_2-open > span")
    actions = ActionChains(driver)
    actions.move_to_element(element).perform()
    ...
    self.driver.find_element(By.ID, "mceu_62").click()
    # 234 | selectFrame | index=0 |  | 
    self.driver.switch_to.frame(0)
    # 235 | editContent | id=tinymce | <p><em><strong>Cracking Your Selenium Interview</strong></em></p> | 
    element = self.driver.find_element(By.ID, "tinymce")
    self.driver.execute_script("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p><em><strong>Cracking Your Selenium Interview</strong></em></p>'}", element)
    # 236 | editContent | id=tinymce | <h1><em><strong>Cracking Your Selenium Interview</strong></em></h1> | 
    element = self.driver.find_element(By.ID, "tinymce")
    self.driver.execute_script("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<h1><em><strong>Cracking Your Selenium Interview</strong></em></h1>'}", element)
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input").send_keys("0.5")
    # 248 | click | css=input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "input").click()
    # 249 | type | css=input | 1.5 | 
    self.driver.find_element(By.CSS_SELECTOR, "input").send_keys("1.5")
    # 250 | click | css=input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "input").click()
    # 251 | type | css=input | 2.5 | 
    self.driver.find_element(By.CSS_SELECTOR, "input").send_keys("2.5")
    # 252 | click | css=input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "input").click()
    # 253 | type | css=input | 3 | 
    self.driver.find_element(By.CSS_SELECTOR, "input").send_keys("3")
    # 254 | click | css=input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "input").click()
    # 255 | type | css=input | 5 | 
    self.driver.find_element(By.CSS_SELECTOR, "input").send_keys("5")
    # 256 | click | css=input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "input").click()
    # 257 | click | linkText=Hovers |  | 
    self.driver.find_element(By.LINK_TEXT, "Hovers").click()
    # 258 | click | css=.figure:nth-child(4) > img |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".figure:nth-child(4) > img").click()
    ...
    self.driver.find_element(By.LINK_TEXT, "Infinite Scroll").click()
    # 262 | runScript | window.scrollTo(0,305) |  | 
    self.driver.execute_script("window.scrollTo(0,305)")
    # 263 | runScript | window.scrollTo(0,1146) |  | 
    self.driver.execute_script("window.scrollTo(0,1146)")
    # 264 | runScript | window.scrollTo(0,1566) |  | 
    self.driver.execute_script("window.scrollTo(0,1566)")
    # 265 | runScript | window.scrollTo(0,1943) |  | 
    self.driver.execute_script("window.scrollTo(0,1943)")
    # 266 | runScript | window.scrollTo(0,2345) |  | 
    self.driver.execute_script("window.scrollTo(0,2345)")
    # 267 | runScript | window.scrollTo(0,3171) |  | 
    self.driver.execute_script("window.scrollTo(0,3171)")
    # 268 | runScript | window.scrollTo(0,3565) |  | 
    self.driver.execute_script("window.scrollTo(0,3565)")
    # 269 | runScript | window.scrollTo(0,4374) |  | 
    self.driver.execute_script("window.scrollTo(0,4374)")
    # 270 | runScript | window.scrollTo(0,5201) |  | 
    self.driver.execute_script("window.scrollTo(0,5201)")
    # 271 | runScript | window.scrollTo(0,5594) |  | 
    self.driver.execute_script("window.scrollTo(0,5594)")
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input").send_keys("1")
    # 276 | click | css=input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "input").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input").send_keys("2")
    # 282 | click | css=input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "input").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input").send_keys("17486328746298743290790")
    # 287 | type | css=input | 1.74863287462987432e+22 | 
    self.driver.find_element(By.CSS_SELECTOR, "input").send_keys("1.74863287462987432e+22")
    # 288 | click | css=input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "input").click()
    # 289 | click | css=input |  | 
    self.driver.find_element(By.CSS_SELECTOR, "input").click()
    ...
    self.driver.find_element(By.LINK_TEXT, "JQuery UI Menus").click()
    # 300 | click | id=ui-id-1 |  | 
    self.driver.find_element(By.ID, "ui-id-1").click()
    # 301 | click | css=.large-4 |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".large-4").click()
    ...
    self.driver.find_element(By.LINK_TEXT, "JavaScript onload event error").click()
    # 324 | click | css=p |  | 
    self.driver.find_element(By.CSS_SELECTOR, "p").click()
    # 325 | click | css=html |  | 
    self.driver.find_element(By.CSS_SELECTOR, "html").click()
    ...
    self.driver.find_element(By.LINK_TEXT, "Large & Deep DOM").click()
    # 334 | storeText | id=sibling-10.3 | NestedDomExample | 
    self.vars["NestedDomExample"] = self.driver.find_element(By.ID, "sibling-10.3").text
    # 335 | storeText | id=no-siblings | NoSiblingDom | 
    self.vars["NoSiblingDom"] = self.driver.find_element(By.ID, "no-siblings").text
    # 336 | storeText | css=.row-9 > .column-8 | TableElementDom | 
    self.vars["TableElementDom"] = self.driver.find_element(By.CSS_SELECTOR, ".row-9 > .column-8").text
    # 337 | assertText | id=header-2 | 2 | 
    assert self.driver.find_element(By.ID, "header-2").text == "2"
    ...
    self.vars["win1036"] = self.wait_for_window(2000)
    # 342 | close |  |  | 
    self.vars["root"] = self.driver.current_window_handle
    # 343 | selectWindow | handle=${root} |  | 
    self.driver.switch_to.window(self.vars["win1036"])
    ...
    self.vars["win137"] = self.wait_for_window(2000)
    # 349 | click | linkText=Notification Messages |  | 
    self.driver.switch_to.window(self.vars["win137"])
    ...
    assert self.driver.find_element(By.ID, "flash").text == "Action successful\n×"
    ...
    assert self.driver.find_element(By.ID, "redirect").text == "here"
    ...
    self.driver.find_element(By.LINK_TEXT, "Example 2: An image").click()
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, "p:nth-child(4) > a")
    actions = ActionChains(driver)
    actions.double_click(element).perform()
    # 386 | click | css=.large-6 |  | 
    self.driver.find_element(By.LINK_TEXT, "click here").click()
    # 387 | click | css=.large-6 |  | 
    self.driver.find_element(By.LINK_TEXT, "Example 3: List").click()
    # 388 | click | css=.large-6 |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".large-6").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "body").click()
    # 399 | click | css=p |  | 
    self.driver.find_element(By.LINK_TEXT, "Slow Resources").click()
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, "h3").text == "Slow Resources"
    ...
    self.vars["TestSortedTableValue"] = self.driver.find_element(By.CSS_SELECTOR, "#table1 .header:nth-child(3) > span").text
    # 406 | click | linkText=Sortable Data Tables |  | 
    self.driver.find_element(By.LINK_TEXT, "delete").click()
    # 407 | click | css=#table1 .header:nth-child(5) > span |  | 
    self.driver.find_element(By.CSS_SELECTOR, "#table1 tr:nth-child(2) a:nth-child(2)").click()
    # 408 | click | css=#table1 .header:nth-child(3) > span |  | 
    self.driver.find_element(By.CSS_SELECTOR, "tr:nth-child(2) > .action > a:nth-child(1)").click()
    # 409 | click | css=#table1 .header:nth-child(4) > span |  | 
    self.driver.find_element(By.CSS_SELECTOR, "tr:nth-child(2) > .action > a:nth-child(2)").click()
    # 410 | click | css=.dues:nth-child(1) |  | 
    self.driver.find_element(By.LINK_TEXT, "Sortable Data Tables").click()
    # 411 | click | css=.first-name:nth-child(1) |  | 
    self.driver.find_element(By.CSS_SELECTOR, "#table1 .header:nth-child(5) > span").click()
    # 412 | click | linkText=Status Codes |  | 
    self.driver.find_element(By.CSS_SELECTOR, "#table1 .header:nth-child(3) > span").click()
    # 413 | click | linkText=301 |  | 
    self.driver.find_element(By.CSS_SELECTOR, "#table1 .header:nth-child(4) > span").click()
    # 414 | click | linkText=Typos |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".dues:nth-child(1)").click()
    # 415 | click | id=content |  | 
    self.driver.find_element(By.CSS_SELECTOR, ".first-name:nth-child(1)").click()
    ...
    actions = ActionChains(driver)
    actions.move_to_element(element).click_and_hold().perform()
    element = self.driver.find_element(By.CSS_SELECTOR, ".\_2BioG:nth-child(1) > span:nth-child(2)")
    actions = ActionChains(driver)
    actions.move_to_element(element).release().perform()
    self.driver.find_element(By.CSS_SELECTOR, "html").click()
